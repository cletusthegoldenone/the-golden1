...
const FEE_ROUTING_BPS = Number(process.env.FEE_ROUTING_BPS || 50);
const TRIAL_DAYS = Number(process.env.TRIAL_DAYS || 30);
const MONTHLY_GROSS_PROFIT_CAP_USD = Number(process.env.MONTHLY_GROSS_PROFIT_CAP_USD || 10000);
const WEEKLY_PASS_USDC = Number(process.env.WEEKLY_PASS_USDC || 20);
